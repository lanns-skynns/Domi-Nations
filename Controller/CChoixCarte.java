...
public class CChoixCarte {
    ...
    int toursRestants;
    private final ArrayList<Integer> numerosCartes = new ArrayList<>();
    private List<Joueur> ordreJoueurs;
    private List<Carte> cartesEnJeu;
    private Joueur joueurQuiChoisis;
    private final ArrayList<Carte> choixDesJoueurs = new ArrayList<>();
    private Carte choixJoueur;
    private CarteChoix choixJoueurPane;
    private final ArrayList<CarteChoix> listeCarteVBox = new ArrayList<>();
    private int n = 0;
    ...
    /* **********
        Méthode appelée que lors du premier tour du jeu et qui initialise quelques variables
     ********** */
    ...
    /* **********
        Méthode qui inititialise chaque nouveau tour de jeu.
     ********** */
    void piocherCartes() {
        tourActuel++;
        this.affichageTour = "tour " + this.tourActuel + "/" + this.nombreDeTour;
    ...
    /* **********
        Méthode d'affichage de la scene où les joeuurs choississent leur carte.
     ********** */
...
*/
    ...
    /* **********
        Méthode qui permet de créer l'ordre des joueurs pour le tour suivant
     ********** */
    ...
    /* **********
        Méthode qui affiche le nom du joueur actuel
     ********** */
